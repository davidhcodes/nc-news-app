    ...
    return (
      <body>
        <div className=" m-auto grid grid-rows-50 grid-cols-2 gap-2 md:grid-rows-20 md:grid-cols-5-w-full">
          ...
          <div className="tile bg-amber-500 row-start-2 row-end-10 col-span-2 md:row-start-2 md:row-end-10 md:col-span-5 w-full h-full">
            {" "}
            <img className="w-full h-full" src={article.article_img_url} />
          </div>
          <div className="tile bg-slate-100 row-start-10 row-end-30 col-span-2 text-left  font-TimesNew">
          ...
          <div className="tile bg-white row-start-30 row-end-35 col-span-2 text-left  font-TimesNew">
          ...
          <div className="tile bg-slate-100 row-start-35 row-end-60 col-span-2">
            <div className="flex">
              <p className="text-left font-TimesNew text-sm ">{article.body}</p>
            </div>
          </div>
